       ...
       <nav class="cl-effect-15" id="cl-effect-15">
          <ul>
            ...
            <ul>
               ...
               <li><a href="childcare.php">Childcare Center</a></li>
               <li><a href="contact_us.php">Contact Us</a></li>
               <li><a href="faq.php">FAQ</a></li>
               <li><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#ModalLogin" id="buttonlogin"><i class="fa fa-user"> &nbsp Login</i></button></li>
              <?php  } else { ?>
